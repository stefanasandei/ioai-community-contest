...
const HeroSection = () => {
  return (
    <section
      id="hero"
      className="min-h-[100svh] pt-24 pb-12 flex items-center justify-center relative overflow-hidden"
    >
      ...
      <div className="relative z-10 text-center max-w-5xl my-auto mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-center gap-8 mb-10">
          ...
          <div className="text-center">
            <div className="text-3xl font-bold text-aicc-red dark:text-[#f28b78] bg-clip-text">
              750+
            </div>
            <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Discord Members
