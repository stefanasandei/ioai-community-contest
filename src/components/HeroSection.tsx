  ...
  return (
    ...
    >
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        <h1 className="text-5xl md:text-6xl bg-gradient-to-r from-aicc-purple to-aicc-orange bg-clip-text text-transparent font-semibold text-gray-900 dark:text-white mb-6">
          AI Community Contest
        </h1>

        <p className="text-xl md:text-2xl text-gray-800 dark:text-gray-200 mb-4 font-normal">
          Codeforces rounds, but for IOAI (not affiliated)
        </p>
