      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-start mb-12">
          ...
          <div className="flex-1 bg-card p-8 rounded-2xl shadow-lg border border-border">
            <h3 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-white">Task Submission Guidelines</h3>
            <ul className="list-disc pl-6 mb-4 text-gray-600 dark:text-gray-400 space-y-2 font-light">
            ...
            <h4 className="font-semibold mt-6 mb-2 text-gray-900 dark:text-white">Required Submission Materials</h4>
            <ol className="list-decimal pl-6 mb-4 space-y-2 font-light text-gray-600 dark:text-gray-400">
              <li>
                <span className="font-medium text-gray-800 dark:text-gray-200">Task Description</span> (Jupyter Notebook or PDF preferred):
              ...
              <li>
                <span className="font-medium text-gray-800 dark:text-gray-200">Datasets</span>:
                <ul className="list-disc pl-6 mt-1 space-y-1">
            ...
            <h4 className="font-semibold mt-6 mb-2 text-gray-900 dark:text-white">Optional but Highly Recommended</h4>
            <ul className="list-disc pl-6 mb-4 space-y-2 font-light text-gray-600 dark:text-gray-400">
            ...
            <h4 className="font-semibold mt-6 mb-2 text-gray-900 dark:text-white">Task Selection Criteria</h4>
            <ul className="list-disc pl-6 mb-4 space-y-2 font-light text-gray-600 dark:text-gray-400">
            ...
            <h4 className="font-semibold mt-6 mb-2 text-gray-900 dark:text-white">Review Process</h4>
            <ul className="list-disc pl-6 mb-4 space-y-2 font-light text-gray-600 dark:text-gray-400">
            ...
            <div className="mt-8 flex flex-col items-center">
              <a
                ...
                className="btn-gradient inline-flex items-center gap-2 px-6 py-3 font-medium rounded-lg mb-2"
              >
                <MessageCircle className="w-5 h-5" />
                Join our Discord to Submit a Task
              </a>
              <span className="text-xs text-gray-600 dark:text-gray-400 font-light">Create a ticket with your task title, materials (Google Drive or GitHub links), and any timing preferences.</span>
            </div>
          </div>
        </div>
      </div>
