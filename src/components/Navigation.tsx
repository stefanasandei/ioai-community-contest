          ...
          <div className="w-full px-6">
            <div className="navigation-balanced items-center h-16">
              <button
                ...
                className="relative group shrink-0 justify-self-start"
              ...
              <div className="navigation-center hidden md:flex items-center">
              ...
              <div className="navigation-actions hidden md:flex items-center gap-2 shrink-0">
                <ThemeToggle />
                <a
                ...
                >
                  ...
                  <span className="navigation-join-full hidden lg:inline">Join Discord</span>
                  <span className="navigation-join-short lg:hidden">Join</span>
                </button>
              </div>

              <div className="navigation-mobile flex items-center gap-2 md:hidden">
                <ThemeToggle />
                <button
